...
static char g_base_url[256] = {0}; // e.g., "http://localhost:10680/v1"
static WeatherRequest g_requests[MAX_REQUESTS] = {0}; // Preallocated requests
static int            g_request_count          = 0; // Number of active requests
